...
for i in daily_transactions_split:
  new_transaction = []
  for y in i: 
    new_transaction.append(y.strip())
...
print(str(color_count('white')) + " - number of white threads sold today.")

colors = ['red','yellow','green','white','black','blue','purple']

for i in colors:
  print('There were {count} threads of {color} sold today.'.format(count=color_count(i),color=i))
